// CMFCDlgGDIDlg.cpp: 实现文件
//

#include "pch.h"
#include "MFCApplication6.h"
#include "CMFCDlgGDIDlg.h"
...
CMFCDlgGDIDlg::CMFCDlgGDIDlg(CWnd* pParent /*=nullptr*/)
...
void CMFCDlgGDIDlg::DoDataExchange(CDataExchange* pDX)
{
...
//BEGIN_MESSAGE_MAP(CMFCDlgGDIDlg, CDialogEx)
//	ON_WM_SYSCOMMAND()
//	ON_WM_PAINT()
//	ON_WM_QUERYDRAGICON()
//	ON_BN_CLICKED(IDC_DRAW_BUTTON, &CMFCDlgGDIDlg::OnBnClickedDrawButton)
//	ON_BN_CLICKED(IDCANCEL, &CMFCDlgGDIDlg::OnBnClickedCancel)
//END_MESSAGE_MAP()
...
BOOL CMFCDlgGDIDlg::OnInitDialog()
{
...
void CMFCDlgGDIDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CMFCDlgGDIDlg::OnQueryDragIcon()
{
...
void CMFCDlgGDIDlg::OnBnClickedDrawButton()
{
	// TODO: 在此添加控件通知处理程序代码
	Draw();
}

void CMFCDlgGDIDlg::Draw()
{
	Money a, b, c;
	Wuzi m, n, z;
	//a.SetNum(100);
...
void CMFCDlgGDIDlg::OnBnClickedCancel()
{
	// TODO: 在此添加控件通知处理程序代码
	CDialogEx::OnCancel();
}
